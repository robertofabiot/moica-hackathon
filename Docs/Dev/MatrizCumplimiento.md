...
- **Corrección de concurrencia**: la fila «Concurrencia sobre el nivel del
  ...
  de iniciar P5, Roberto debe revisar a posteriori el rango `9790215..f88edff`.
...
| Bucket privado real | Los diez pasos de `Almacenamiento.md` | **No** | | **Pendiente.** El 28 de agosto de 2026 se volvió a comprobar el entorno: siguen sin definirse `MOICA_R2_PRIVADO_ID_CUENTA`, `MOICA_R2_PRIVADO_ACCESS_KEY_ID`, `MOICA_R2_PRIVADO_SECRET_ACCESS_KEY` y `MOICA_R2_BUCKET_PRIVADO`. Ninguno de los diez pasos se ejecutó. P4V no pide secretos por ningún canal |
