...
\node[usecase] (UC_Rep) at (7, 3.5) {Reportar a la contraparte\\(abre caso de moderación)};
...
\node[usecase] (UC_CRep) at (19, 8.5) {Consultar casos\\de moderación};
\node[usecase] (UC_RevE) at (19, 5.5) {Revisar evidencias\\del caso};
\node[usecase] (UC_ResR) at (19, 2.5) {Resolver caso\\(Procedente / Desestimado)};
\node[usecase] (UC_EmiM) at (19, -0.5) {Aplicar o revocar\\medida administrativa};
