...
- **Rama**: `feature/ui-pie-de-pagina-y-componentes-base` nace de `develop`
  actualizado. El PR se abre contra esa rama, no contra `main`.
...
| Nace de `develop` | `git merge-base origin/develop HEAD` | Sí | | Devuelve `0b17f46`, el HEAD de `develop`. El PR se abre contra esa rama, no contra `main` |
