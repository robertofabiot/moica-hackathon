...
- **CI**: este PR se abre contra `develop` como #18. Los enlaces de CI se
  anotan cuando existan; no se describen de memoria.
- **Rama**: `feat/ui-configuracion-cuenta` nace de `develop` en `a9884a9`, el
  HEAD de esa rama al abrir el PR.
...
| Capturas a tres tamaños | Chrome a 375x812, 768x1024 y 1280x800 | **No** | | **Pendiente.** No hay todavía el juego de capturas con `scrollWidth == clientWidth`. Se dejan bloques vacíos en el PR #18 para pegarlas |
