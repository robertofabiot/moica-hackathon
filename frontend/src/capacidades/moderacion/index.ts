...
export { RUTA_ADMIN_CASOS, RUTA_ADMIN_EXPEDIENTE, rutaDeExpediente } from './rutas';
export type { EstadoDeCaso, ExpedienteDeCaso as DatosDeExpediente, ResumenDeCaso } from './tipos';
