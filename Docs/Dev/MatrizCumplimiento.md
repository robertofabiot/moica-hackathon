...
nota de las tarjetas es maqueta visual hasta P8. El detalle público se maqueta
...
| Desglose de reseñas | `DetalleDeServicio.test.tsx` | Sí | | 4.8 «De 5» y barras `--color-primary-500` para 5, 4 y 3 estrellas (80 / 30 / 10). Maqueta visual; P8 no entra aquí |
...
El contrato de `GET /api/servicios/{id}` no cambia. La reputación de la ficha es
maqueta visual hasta P8. Guardar no persiste: solo alterna el estado local.
