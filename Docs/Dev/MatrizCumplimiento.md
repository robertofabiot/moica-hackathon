...
- **Validación local con Docker activo** (2 de septiembre de 2026, sobre
  `803a6f1`, ya con `develop` y el #27 integrados). Docker Engine 29.7.2,
  Docker Desktop. En `backend`, `./mvnw -B -ntp verify`: **Surefire 167 y
  Failsafe 488, ambos con 0 fallos, 0 errores y 0 omitidas**, Spotless limpio,
  SpotBugs sin hallazgos y `BUILD SUCCESS` en 5:10 min. Testcontainers 1.21.4
