...
- **CI**: ejecutado por GitHub Actions en el Pull Request #9. Sobre su commit
  final `237b4e4`,
  ...
  dejaron los cuatro checks en verde: «Backend (Java 21)» en 1m31s, «Frontend
